...
<section id="data-sekolah" class="py-20 bg-gradient-to-br from-primary to-blue-800">
    <div class="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16 text-center">
        ...
        <p class="text-blue-100 max-w-xl mx-auto mb-4 text-base leading-relaxed">
        ...
        <p class="max-w-xl mx-auto mb-4">
            <span class="inline-flex items-center gap-2 bg-secondary/20 text-yellow-100 border border-secondary/50 px-4 py-1.5 rounded-full text-sm font-medium shadow-sm backdrop-blur-sm">
        ...
        <div class="mb-10">
            <a href="https://share.google/L59lDHO1FKJafsSY3" target="_blank" rel="noopener noreferrer"
               class="inline-flex items-center gap-2 px-5 py-2.5 bg-blue-900/40 text-blue-100 border border-blue-400/30 hover:bg-blue-800/80 hover:text-white rounded-lg text-sm font-medium transition-all duration-300 hover:-translate-y-0.5">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<script>
    ...
    // Load GeoJSON
    fetch('<?= base_url("data/map-fix-banget.geojson") ?>')
        .then(res => res.json())
        .then(data => {
            if (data.features) {
